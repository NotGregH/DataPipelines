...
mkdir STIS
mkdir Picard
bwa-mem2 mem -M -t 40 ./../../Genomes/hg19mm10v3/bwahg19v2/hg19 ./../rawFastqs/$FILE ./../rawFastqs/${FILE/R1.fp/R2.fp} | samtools view -@ 30 -h -b -S -F 4 - | samtools sort -@ 10 -o $BAM -
samtools index $BAM
...
samtools view -b -h -@ 30 -q 55 ${BAM/Align/BLF} > ${BAM/Align/Final}
